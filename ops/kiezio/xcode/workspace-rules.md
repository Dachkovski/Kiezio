...
- Request camera and microphone only inside the explicit video-call flow after pre-call safety copy.
...
- visible video-call hang up, mute, camera toggle, report, and block controls when video chat is enabled.
...
- video-call permission denial, mute, camera toggle, report entry, and end-call states.
